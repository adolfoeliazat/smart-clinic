...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { address: @hospital.address, department: @hospital.department, doctor: @hospital.doctor, name: @hospital.name } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { address: @hospital.address, department: @hospital.department, doctor: @hospital.doctor, name: @hospital.name } }
